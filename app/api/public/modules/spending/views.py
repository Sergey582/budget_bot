from app.api.public.modules.spending.serializers import (
    CategoriedListData, CategoriesStatisticsData, CreateSpendingRequest,
    CurrenciesListData, ExpenseResponse, ExpensesListData,
    ExpensesQueryFilters, Pagination, UpdateExpenseRequest)
...
async def router_get_expenses(
    ...
    messages, next_id = get_last_expense_id(messages, pagination.limit)
